...
exports.checkRight = void 0;
var user_1 = require("../model/user");
var ObjectId = require('mongoose').Types.ObjectId;
var checkRight = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, ressourceId, user, id_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4: return [2 /*return*/, res.status(403).send()];
        }
    });
}); };
exports.checkRight = checkRight;
//# sourceMappingURL=checkRight.js.map